...
\subsection*{Risk Assessment Tables}
...
{\renewcommand{\arraystretch}{1.8}%
  \begin{table}[ht]
    ...
    \begin{tabular}{|>{\columncolor{riskGray}}C{2cm}|C{0.9cm}|C{2.4cm}|C{2.4cm}|C{2.4cm}|C{2.4cm}|C{2.4cm}|}
      \hline
      \multirow{5}{*}{\centering\textbf{Severity (S)}} &
      V                                                                      &
      ...
      \hline
      \multicolumn{2}{|c|}{}                                                 &
      \multicolumn{5}{c|}{\textbf{Likelihood (L)}}                             \\
      \hline
...
\begin{table}[htbp]
  \centering
  \caption{GHG emissions summary by source and scope.}
  \label{tab:ghg_emissions_summary}
  \small
  \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|c|c|}
    \hline
    \textbf{Source} & \textbf{Cause} & \textbf{GHG emissions (ton/year)} & \textbf{Scope} \\
    \hline
    \rowcolor{gray!20}\multicolumn{4}{|c|}{\textbf{CO$_2$}} \\
    \hline
    Main process (CO$_2$) & 40.4 kg CO$_2$ per batch & 2.1008 & 1 \\
    \hline
    Incineration (CO$_2$) & 19600 kg per batch & 1019.2 & 1 \\
    \hline
    Steam (main) & 1078 ton/year & 71.148 & 2 \\
    \hline
    Energy demand (main) & 894400 kWh (annual) & 268.32 & 2 \\
    \hline
    Energy demand (waste) & 865000 kWh (annual) & 259.5 & 2 \\
    \hline
    \rowcolor{gray!20}\multicolumn{4}{|c|}{\textbf{Total}} \\
    \hline
    Scope 1 &  & 1021.3008 &  \\
    \hline
    Scope 2 &  & 598.968 &  \\
