...
\usepackage{etoolbox}
% Bibliography: left-align, prevent overflow, allow URL line breaks
...
\usepackage[style=numeric, sorting=none, maxbibnames=1, minbibnames=1]{biblatex}
...
\usepackage{longtable,array,xcolor,colortbl,booktabs}
